 ...
 * Use the {@link ComedyMovieFragment#newInstance} factory method to
...
public class ComedyMovieFragment extends Fragment {
    ...
    public static ComedyMovieFragment newInstance(String param1, String param2) {
        ComedyMovieFragment fragment = new ComedyMovieFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_comedy_movie, container, false);

        rcv = view.findViewById(R.id.rcvComedyMovie);
        ...
        movies = MovieDatabase.getInstance(getActivity()).movieDAO().filterMovieByCategory("Comedy Movies");
        adapter.setMovies(movies);
