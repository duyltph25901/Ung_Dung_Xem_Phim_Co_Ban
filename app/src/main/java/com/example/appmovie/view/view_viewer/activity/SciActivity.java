...
public class SciActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private void init() {
        rcv = findViewById(R.id.rcvShowSciMovie);
        imgSearch = findViewById(R.id.imgSearchMovieSci);
        inputSearchMovie = findViewById(R.id.inputSearchMovieByNameSciMovie);
        lottieAnimationView = findViewById(R.id.imageNoDataSci);
        swipeRefreshLayout = findViewById(R.id.refreshSci);
    ...
    private void loadData() {
        movies = MovieDatabase.getInstance(this).movieDAO().filterMovieByCategory("Sci-fi Movies");
        adapter.setMovies(movies);
    }
    ...
    private void search() {
        ...
        if (key.isEmpty()) {
            ...
            movies = new ArrayList<>();
            movies = MovieDatabase.getInstance(this).movieDAO().filterMovieByCategoryAndName("Sci-fi Movies", key);
            adapter.setMovies(movies);
