...
public class AnimatedActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private void init() {
        rcv = findViewById(R.id.rcvShowAnimatedMovie);
        imgSearch = findViewById(R.id.imgSearchMovieAnimated);
        inputSearchMovie = findViewById(R.id.inputSearchMovieByNameAnimatedMovie);
        lottieAnimationView = findViewById(R.id.imageNoDataAnimated);
        swipeRefreshLayout = findViewById(R.id.refreshAnimated);
    ...
    private void loadData() {
        movies = MovieDatabase.getInstance(this).movieDAO().filterMovieByCategory("Animated Movies");
        adapter.setMovies(movies);
    }
    ...
    private void search() {
        ...
        if (key.isEmpty()) {
            ...
            movies = MovieDatabase.getInstance(this)
                    .movieDAO().filterMovieByCategoryAndName("Animated Movies", key);
            adapter.setMovies(movies);
