...
public class ActorsFragment extends Fragment {
    ...
    private void init(View view) {
        img = view.findViewById(R.id.imgActor);
        inputFullName = view.findViewById(R.id.inputFullNameActor);
        txtDateOfBirth = view.findViewById(R.id.txtDateOfBirthActor);
        inputCountries = view.findViewById(R.id.inputCountriesActor);
        inputStory = view.findViewById(R.id.inputStoryActor);
        txtDisplayCountries = view.findViewById(R.id.txtDisplayCountriesNameActor);
        btnClear = view.findViewById(R.id.btnClearActor);
        btnInsert = view.findViewById(R.id.btnInsertActor);
        btnChooseImage = view.findViewById(R.id.btnChooseImageActor);
        radioMale = view.findViewById(R.id.radioMaleActor);
        radioFemale = view.findViewById(R.id.radioFemaleActor);
        radioOther = view.findViewById(R.id.radioOtherActor);
    ...
    private void insert() {
        ...
        actorSearch = ActorDatabase.getInstance(getActivity()).actorDAO().searchActorByName(fullName);
        if (actorSearch != null) {
            Toast.makeText(getActivity(), "The name already exists in the list!", Toast.LENGTH_SHORT).show(); return;
        }

        Actor actor = new Actor(ConvertImageStore.imagemTratada(ConvertImageStore.convertImageToByArr(bitImage)),
